...
Be specific and detailed. Use the terminology and style that would appear in relevant documents."""
        ...
        try:
            ...
            log_info(f"Generated HyDE document: {response.content[:100]}...")
...
Format as a simple list:"""
        ...
        try:
            ...
            variations = [line.strip().lstrip('123.-• ') 
            ...
            log_info(f"Generated {len(variations)} query variations")
...
List only the key search terms, separated by commas:"""
    ...
    def decompose_complex_query(self, query: str) -> List[str]:
        ...
        prompt = f"""Break down this complex question into 2-4 simpler, focused sub-questions that together would fully answer the original question.
...
Return only the category name:"""
        ...
        try:
            ...
            valid_intents = ['factual', 'analytical', 'procedural', 'comparative', 'general']
