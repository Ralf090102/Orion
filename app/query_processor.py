...
class QueryProcessor:
    ...
    def __init__(self):
        ...
        self.intent_patterns = {
            ...
            QueryIntent.ANALYTICAL: [
                ...
                r'\banalyze\b', r'\bevaluate\b'
            ],
            QueryIntent.PROCEDURAL: [
                r'\bhow to\b', r'\bhow do i\b', r'\bsteps to\b', r'\bguide\b',
                r'\btutorial\b', r'\binstruct\b'
            ],
            QueryIntent.TROUBLESHOOTING: [
                r'\bwhy.*not work\b', r'\bwhy.*doesn\'t.*work\b', r'\berror\b', r'\bproblem\b', r'\bissue\b',
                r'\bfix\b', r'\bdebug\b', r'\btrouble\b', r'\bsolve\b', r'\bwhy.*getting\b'
            ],
            QueryIntent.CREATIVE: [
                r'\bwrite\b', r'\bcreate\b', r'\bgenerate\b', r'\bbuild\b',
                r'\bmake\b', r'\bdesign\b'
            ],
            QueryIntent.EXPLORATORY: [
                r'\btell me about\b', r'\blearn about\b', r'\bexplore\b',
                r'\boverview\b', r'\bintroduce\b'
            ]
        }
    ...
    def extract_keywords(self, query: str) -> List[str]:
        ...
        stop_words = {
            ...
            'of', 'with', 'by', 'how', 'what', 'when', 'where', 'why', 'is', 'are',
    ...
    def validate_query(self, query: str, keywords: List[str]) -> tuple[bool, str]:
        ...
        personal = [r'\bmy personal\b', r'\bi am\b', r'\bmy private\b', r'\bmy account\b']
        ...
        technical_domains = ['programming', 'code', 'software', 'computer', 'algorithm', 
                           'function', 'class', 'method', 'api', 'database']
        if any(word in query.lower() for word in technical_domains):
            return True, "Query appears to be about technical topics we likely have documentation for"
