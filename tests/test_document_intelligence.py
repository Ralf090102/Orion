...
from app.document_intelligence import (
    DocumentTypeDetector, MetadataEnricher, SmartChunker,
...
"""
        ...
        keywords_found = any(kw in metadata.keywords for kw in 
                           ['machine learning', 'neural network', 'api', 'python', 'database', 'docker', 'aws'])
